...
public class GlobalPose {
    ...
    public static class BLUE {
        ...
        public static class BlueNearZonePose {
            ...
            public static final Pose pushLeverPath1 = new Pose(14.83, 77.11, Math.toRadians(270));
            public static final Pose pushLeverPath2 = new Pose(6.98, 74.2, Math.toRadians(270));
        ...
        public static class PICKUP_POSE_BLUE {
            ...
            public static final Pose pickup2_2 = new Pose(19.71, 58.32, Math.toRadians(180));
            public static final Pose pickup3_1 = new Pose(42.8, 36.37, Math.toRadians(180));
            public static final Pose pickup3_2 = new Pose(16.24, 36.37, Math.toRadians(180));
    ...
    public static class RED {
        public static final Pose scorePoseEnd = new Pose();

        public static class RedNearZonePose {
            //Pose start, score
            public static final Pose startPose = new Pose(97.33, 136.35, Math.toRadians(0));
            public static final Pose scorePose = new Pose();
            //Pose End
            public static final Pose endPose = new Pose();
            public static final Pose pushLeverPath1 = new Pose();
            public static final Pose pushLeverPath2 = new Pose();
        }

        public static class RedFarZonePose {
            public static final Pose startPose = new Pose(92.83, 6.5, Math.toRadians(0));
            public static final Pose scorePose = new Pose();
            public static final Pose endPose = new Pose();
            public static final Pose pushLever = new Pose();
        }

        public static class PICKUP_POSE_RED {
            public static final Pose pickup1_1 = new Pose(102.98, 86.96, Math.toRadians(0));
            public static final Pose pickup1_2 = new Pose(126.4, 86.96, Math.toRadians(0));
            public static final Pose pickup2_1 = new Pose(102.89, 62.75, Math.toRadians(0));
            public static final Pose pickup2_2 = new Pose(128.46, 62.75, Math.toRadians(0));
            ...
            public static final Pose indulge1 = new Pose();
            public static final Pose indulge2 = new Pose();
        }
    }
}

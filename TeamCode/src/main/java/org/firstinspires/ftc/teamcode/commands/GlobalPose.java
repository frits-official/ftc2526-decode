...
public class GlobalPose {
    ...
    public static final Pose pushLeverBlue = new Pose(13.12, 70.49, Math.toRadians(270));
    ...
    public static class PICKUP_POSE_BLUE {
        ...
        public static final Pose pickup2_2 = new Pose(22.2, 61.8, Math.toRadians(180));

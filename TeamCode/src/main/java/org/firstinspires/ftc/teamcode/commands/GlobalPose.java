...
public class GlobalPose {
    ...
    public static class RED {
        public static final Pose scorePoseEnd = new Pose(97.95, 114.78, Math.toRadians(45));
        ...
        public static class RedNearZonePose {
            ...
            public static final Pose pushLeverPath2 = new Pose(130.72, 72.75, Math.toRadians(270));
        }

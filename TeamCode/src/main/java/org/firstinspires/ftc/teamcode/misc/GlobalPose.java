...
public class GlobalPose {
    ...
    public static class BLUE {
        public static class RETAKE_POSE {
            public static final Pose pushLever = new Pose(11.44, 59.65, Math.toRadians(159));
            public static final Pose reTake = new Pose(8.72, 56.27, Math.toRadians(109));
        }
        public static class BASIC_POSE_NEAR {
            ...
            public static final Pose endPose = new Pose(51.25, 113.97, Math.toRadians(225));
        ...
        public static class PICKUP_POSE {
            public static final Pose pickup1 = new Pose(14.94, 84.17, Math.toRadians(180));
            public static final Pose pickup2 = new Pose(15.72, 56.93, Math.toRadians(180));
    ...
    public static class RED {
        public static final Pose pushLever = new Pose(128.76, 62.05, Math.toRadians(22));
        public static final Pose reTake = new Pose(132.78, 56.27, Math.toRadians(71));
        public static class BASIC_POSE_NEAR {
            ...
            public static final Pose endPose = new Pose(94.87, 121.14, Math.toRadians(-45));
        }
        ...
        public static class PICKUP_POSE {
            public static final Pose pickup1 = new Pose(121.68, 86.41);
            public static final Pose pickup2 = new Pose(128.25, 58.22);

...
public class GlobalPose {
    ...
    public static class BLUE {
        public static final Pose pushLever = new Pose(13.73, 59.9, Math.toRadians(140));
        public static final Pose reTake = new Pose(10.12, 56.11, Math.toRadians(130));
        ...
        public static class PICKUP_POSE {
            public static final Pose pickup1 = new Pose(21.44, 84.2, Math.toRadians(180));
            public static final Pose pickup2 = new Pose(14.88, 59.46, Math.toRadians(180));
